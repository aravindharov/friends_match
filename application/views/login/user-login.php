...
<html lang="en">
	...
	<head>
		...
		<!--end::Layout Skins -->
	<link rel="shortcut icon" href="<?php echo asset_url ?>settings/<?php echo $fetch[0]['setLogo']; ?>"  >
	</head>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
							...
							<div class="kt-login__container">
								<div class="kt-login__body">
									<div class="kt-login__logo">
										<a href="#">
												<img src="<?php echo asset_url ?>settings/<?php echo $fetch[0]['setLogo']; ?>" style="width:150px;">
										</a>
									</div>
					...
					<input type="hidden" name="type" value="1">
									...
									<div class="kt-login__signup">
										...
										<div class="kt-login__form">
											<form class="kt-form" action="" id="upload" method="post">
												...
												<!-- <div class="form-group">
													<input class="form-control " type="text" placeholder="NRIC last 3 digit and Alphabets" name="uNric">
													<span class="invalid-feedback"></span>
												</div> -->
												
												
												<div class="kt-login__extra--" style="text-align: justify;">
													<?php echo $fetch[0]['setTerm']; ?>
												</div>

												<div class="kt-login__actions">
													<div style="margin-bottom: 10px;">
													<input type="checkbox" class="form-control" style="padding: 5px; height: 15px; width: 20px; margin-top: 10px;display: inline-block;margin-top: 5px" name="confirm" value="1"><b style=""> I Accept Terms and Condition </b>
													<span class="invalid-feedback"></span>
												</div>
							...
							<div class="kt-login__account">
								...
								<a href="javascript:;" id="kt_login_forgot" class="kt-link kt-login__link">Click here ?</a>
							</div>
						</div>
					</div>
...
// });
		...
		<script>
			$(document).ready(function() {
			    ...
			    $("#forgotUpload").on("submit", function(event) {
			        var dat=new FormData( this );
			       	$('#forget').addClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', true);
			    	$('#loader').hide();
			        var desc = $("#abstract_1").html();
					...
					$('#loader').show();
		           	...
		           	$.ajax({
						type: "POST",
						url: "<?php echo site_url; ?>login/checkForgotUser",
						dataType: "json",
						data: dat,
						cache: false,
						dataType: 'json',   
						...
						success: function(html) {
							...
							if (html.status == 0) {
		                        ...
		                        var s = 0;
		                           ...
		                           if (s < 1) {
		                               $("#forgotUpload [name='" + k + "']").focus();

		                               s++;
		                           }
		                           var k1 = $("#forgotUpload [name='" + k + "'] ~span.invalid-feedback");
		                 			k1.html(v);
		                 			$("#forgotUpload [name='"+k+"']").addClass( "is-invalid" );
		                       	});
		                    }
		                   	else if(html.status==2)
		                   	{
		                   		swal.fire(html.message, "", "error").then(function(result){})
		                   	} 
		                   	else
				           	{
								$('#loader').hide();
		               	...
		               	complete: function(data) {
		                    $('#loader').hide();
							$('#forget').removeClass('kt-spinner kt-spinner--right kt-spinner--sm kt-spinner--light').attr('disabled', false);
							$("#forgotUpload [name='submit']").attr('disabled',false);
		               	},
		               	error: function(jqXHR, textStatus, errorThrown) {
		                	swal.fire({
								title: "Please try again!",
