...
<html lang="en">
	...
	<head>
		...
		<!--end::Layout Skins -->
		<link rel="shortcut icon" href="<?php echo asset_url; ?>settings/<?php echo $setting['setLogo']; ?>" />
	</head>
				...
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
							...
							<div class="kt-login__container">
								<div class="kt-login__body">
									<div class="kt-login__logo">
										<a href="#">
											<img src="<?php echo asset_url; ?>settings/<?php echo $setting['setLogo']; ?>" style="width:150px;">
										</a>
									</div>
					...
					<!-- <input type="hidden" name="type" value="1"> -->
									...
									<!-- <div class="input-group">
										<input value="<?php echo $form_data['user_name'] ?>" required name="ucEmail" type="text" placeholder="Email" class="form-control" autofocus/>
										
									</div> -->
									<!-- <?php $x=$this->input->get('key');?>-->
								...
								<?php } 
									...
									{?>
									<!-- <input name="key" type="hidden"  class="form-control" value="<?= $x ?>"> -->
									...
									<!-- <div class="kt-login__actions">
										<button type="submit"  class="btn btn-brand btn-elevate kt-login__btn-primary">Verify</button>
									</div> -->
									<div class="form-group">
												...
												<div class="kt-login__actions">
													...
													<button id="kt_login_signup_cancel" class="btn btn-outline-brand btn-pill"><a href="<?= site_url ?>/login">Cancel</button>
												</div>
							...
							<div class="kt-login__account">
								...
								<a href="<?= site_url ?>login" id="kt_login_login" class="kt-login__account-link">Login</a>
							</div>
						</div>
					</div>
