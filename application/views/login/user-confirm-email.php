		...
		<div class="kt-grid kt-grid--ver kt-grid--root kt-page">
			<div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v6 kt-login--signin" id="kt_login">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
					<div class="kt-grid__item  kt-grid__item--order-tablet-and-mobile-2  kt-grid kt-grid--hor kt-login__aside" style="margin: 0 auto;width: 900px">
						<div class="kt-login__wrapper">
							<div class="kt-login__container" style="width: 100%">
								<div class="kt-login__body">
									<div class="kt-login__logo">
										<a href="#">
											<img alt="Logo" src="<?php echo asset_url ?>image/bike.jpg" style="width: 150px;" />
										</a>
									</div>
									<div class="kt-login__signin">
										
										<div class="kt-login__form">
											<form class="kt-form" action="" method="post" class="" id="upload">
       ...
       $("#upload").on("submit", function(event) {
        ...
        //     }).then(function(result) {
         ...
         event.preventDefault();
           var x = 0;
           $('#upload [name="count[]"]').each(function() {
               x++;
           });
           var y = 0;
           $('#upload [name="fileName[]"]').each(function() {
               y++;
           });
           if (x == y) {
               ...
               $.ajax({
                   type: "POST",
                   url: "<?php echo site_url; ?>login/mailVerifyProcess",
                   dataType: "json",
                 //  data: data11,
                   data: dat,
                   cache: false,
