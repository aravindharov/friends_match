  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo asset_url.'image/'.$user['user_picture'];?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block" title="<?php echo $user['user_fname'];?>"><?php echo $user['user_fname'];?></a>
        </div>
        <div class="info">
          <a href="<?php echo site_url.'home/logout'?>" class="float-right" style="margin-left: 100px;" title="<?php echo $user['user_fname'];?>">Logout</a>
        </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url.'home/search_friend'?>" class="nav-link <?php  if ($menu==2){
              echo "active";
              } ?>">
              <i class="far fa-circle nav-icon"></i>
              <p>Search Friend</p>
          ...
          <li class="nav-item <?php  if ($menu==3){
            ...
            <a href="<?php echo site_url.'home/matches_friend'?>" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>Matches</p>
            </a>
          </li>
